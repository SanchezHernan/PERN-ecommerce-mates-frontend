    ...
    return(
        <div className='pagenotfound-container'>
            <div className='algo'>    
                ...
                <h3 className='NotFoundSubtitle'>OH OH! Te has perdido.</h3>
                <p className='p-text'>La página que estas buscando no existe.
                Como llegaste aquí es un misterio. Pero puedes clickear el boton de aquí
                abajo para volver a la página de inicio.
                </p>
                <button className="btn g-btn green" onClick={goToHome}>HOME</button>
            </div>
            </div>
        </div>
    )
